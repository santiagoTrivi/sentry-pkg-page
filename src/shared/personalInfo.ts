...
export const CreatedProjects: projectsProps[] = [
  {
    ...
    gitHubRepoUrl:
      "https://github.com/santiagoTrivi/proyecto-banco-saint-patrick/",
  ...
  },
  {
    ...
    description:
      "My portfolio. Create with React vite and deploy in github pages. ",
